    ...
    <div class="profile-layout">
        ...
        <aside class="profile-sidebar">
            ...
            <ul class="sidebar-menu">
                <li><a href="#"><i class="iconoir-app-window"></i> Dashboard</a></li>
                <li><a href="{{ route('profile.edit') }}" class="active"><i class="iconoir-user"></i> Profile info</a></li>
                <li><a href="#"><i class="iconoir-box-iso"></i> Orders</a></li>
                <li><a href="#"><i class="iconoir-map-pin"></i> Addresses</a></li>
